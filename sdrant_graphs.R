...
group.colors <- c("pollination"="#E69F0055", "seed dispersal"="#D55E0055", "seed predation"="#F0E44255", "herbivory" = "")
...
top_row <- plot_grid(papers, evolpapers, paperstime, labels = c('A', 'B', 'C'), label_x = 0.1, label_y = 0.1, hjust = -0.25, vjust = -0.25, nrow=1, rel_widths = c(1,1, 1.25), align='hv', axis='b')
bottom_row <- plot_grid(grants, textbooks, ipbes, fig2legend, labels = c('D', 'E', 'F', ''), label_x = 0.07, label_y = 0.07, hjust = -0.3, vjust = -0.1, nrow=1, rel_widths = c(1,1,1,0.75), axis='b', align='v')
Fig2<-plot_grid(top_row, bottom_row, nrow=2)

save_plot("fig2new.pdf", Fig2, base_width = 7)
